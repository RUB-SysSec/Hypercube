...
typedef uint8_t* opcode_bitmap_t;

#define ALLOC_OPCODE_BITMAP(bitmap) bitmap = malloc(32)
#define ZERO_OPCODE_BITMAP(bitmap) memset(bitmap, 0, 32)
#define INIT_OPCODE_BITMAP(bitmap) memset(bitmap, 0xFFFFFFFF, 32)
#define SET_OPCODE_BITMAP(bitmap, id) (bitmap[id/8] |= (1 << (id%8)))
#define RESET_OPCODE_BITMAP(bitmap, id) (bitmap[id/8] &= ~(1 << (id%8)))
#define CHECK_OPCODE_BITMAP(bitmap, id) ((bitmap[id/8] & (1 << (id%8))))
...
#define HEXA_OP_BITMAP_SIZE (0x1000 / sizeof(hexa_op) / 8)
