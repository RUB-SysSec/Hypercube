...
static uint32_t decompiler_mmio_write_dict_data(state_t* state_obj, hexa_op* input, uint8_t size){
	uint32_t offset, slot;
	op_mmio_write_dict_8* op = (op_mmio_write_dict_8*) input;
	...
	if(state_obj->num_mmio_areas){
		...
		switch(size){
			case 0:	printf("mmio_write_8   (0x%x + mmio_area[%d], 0x%x); /* data dict offset */\n\r", offset, slot, ((op_mmio_write_8*)op)->data);
					return sizeof(op_mmio_write_dict_8);
			case 1: printf("mmio_write_16  (0x%x + mmio_area[%d], 0x%x); /* data dict offset */\n\r", offset, slot, ((op_mmio_write_16*)op)->data);
					return sizeof(op_mmio_write_dict_16);
			case 2: printf("mmio_write_32  (0x%x + mmio_area[%d], 0x%x); /* data dict offset */\n\r", offset, slot, ((op_mmio_write_32*)op)->data);
					return sizeof(op_mmio_write_dict_32);
			default:
					abort();
		}
...
uint32_t decompiler_mmio_write_dict_data_32(state_t* state_obj, hexa_op* input){
	return decompiler_mmio_write_dict_data(state_obj, input, 2);
}

uint32_t decompiler_mmio_write_dict_data_16(state_t* state_obj, hexa_op* input){
	return decompiler_mmio_write_dict_data(state_obj, input, 1);
}

uint32_t decompiler_mmio_write_dict_data_8(state_t* state_obj, hexa_op* input){
	return decompiler_mmio_write_dict_data(state_obj, input, 0);
}
